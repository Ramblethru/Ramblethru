...
=== Technologies:
Ruby on Rails, Javascript, jQuery, HTML5, CSS3, SASS, Bourbon/Neat/Bitters, Foursquare API, Yelp API, Reddit API, Instagram API, Postgres, Geocoder, Mapbox.js, Sendgrid, Photoshop CC, Paperclip, AWS S3, Heroku
